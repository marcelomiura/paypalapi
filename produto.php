            ...
            <div class="span8">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="tdCenter"><input type="number" class="form-control" ng-model="value"></td>
                        ...
                        <td>
                            ...
                            <a href="#/information" ng-click="setValue()" class="btn btn-block btn-sm btn-primary" role="button"> continue </a>
